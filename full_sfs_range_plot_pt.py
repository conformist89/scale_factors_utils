...
with open("config_tags.yaml", 'r') as stream:
    out = yaml.load(stream)
    user_out_tags = list(out[args.era].values())



correction_factors, up_uncertainties, down_uncertainties = get_pt_correction_factors(args.era, user_out_tags, 'mt',5)




lumilabel = r"16.8 $fb^{-1}$"+" (2016 postVFP UL) (13 TeV)"
...
# Save as PDF and PNG
plt.savefig(outname+"_v1_v1.pdf")
plt.savefig(outname+"_v1_v1.png", dpi=300)  # High-resolution PNG
